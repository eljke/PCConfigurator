...
import stylesCss from 'themes/PCConfigurator/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_PCConfigurator_componentCss']) {
    
    document['_vaadintheme_PCConfigurator_componentCss'] = true;
  }
